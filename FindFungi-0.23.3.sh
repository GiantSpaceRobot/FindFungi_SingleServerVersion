...
##### USER INPUT REQUIRED:
ScriptPath=/home/paul/Documents/Pipelines/FindFungi/FindFungi-v0.23.3  #Location of downloaded python and shell scripts
PreDir=/home/paul/Documents/Pipelines/FindFungi/Results/$z  #Location you want FindFungi to build the analysis
KrakenDir=/home/paul/Documents/Pipelines/FindFungi/DBs/Kraken_32DB  #Location of the 32 downloaded Kraken databases
FungTaxDir=/home/paul/Documents/Pipelines/FindFungi/FindFungi-v0.23.3  #Location of the Fungal taxids and PipelineSummary files from GitHub
BLAST_DB_Dir=/home/paul/Documents/Pipelines/FindFungi/DBs/FungalGenomeDatabases_EqualContigs  #Location of the 949 downloaded BLAST databases
#####
...
for i in $(seq 1 32); do
	echo "Running Kraken on database $i..."
...
for d in $Dir/Processing/SplitFiles_Kraken/*; do #Sort individual Kraken output files
	File=$(basename $d)
	sort --parallel 16 -o $Dir/Processing/SplitFiles_Kraken/sorted_$File -k2,2 $d & 
done
wait
sort --parallel 16 -o $Dir/Processing/sorted.$z.All-Kraken-Results.tsv -m -k2,2 $Dir/Processing/SplitFiles_Kraken/*sorted* & #Merge and sort all Kraken output files
wait
...
### Remove all empty files
find $Dir/Results/BLAST_Processing/ -name 'BLAST*' -empty -exec rm '{}' ';'
...
#FungalRead=$( bc -l <<< ${FungalReadsBLAST_FungiBacteria}/${ReadsIn}) # This line was causing issue
FungalRead=$(echo "scale=2 ; $FungalReadsBLAST_FungiBacteria / $ReadsIn" | bc) # This line replaces the line above
